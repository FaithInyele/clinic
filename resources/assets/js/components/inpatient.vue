                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div class="accordion">
                                                        ...
                                                        <div class="row" style="margin-bottom: 10px">
                                                            <hr>
                                                            <div class="row">
                                                                <a style="font-size: 10px" class="btn btn-primary btn-sm" @click="recommendLab">Recommend Lab Test(s)</a> |
                                                                <a style="font-size: 10px " class="btn btn-primary btn-sm" @click="prescribeMedication">Prescribe Medication</a>  |
                                                            </div>
                                                                ...
                                                                <div class="row" v-for="result in results">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-2" style="padding-top: 10px">
                                                                            <button v-if="result && currentTicket.progress" v-show="result.status==false" :class="{btn:classLoad, 'btn-sm':classLoad, 'btn-success':classLoad}" @click="addTest(result)">Add</button>
                                                                            <button v-if="result && currentTicket.progress" v-show="result.status==true" :class="{btn:classLoad, 'btn-sm':classLoad,  'btn-danger':classLoad}" @click="removeTest(result)">Remove</button>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
    ...
    export default {
        ...
        methods:{
            ...
            allActiveMethod: function () {
                var inheritance = this;
                axios.get(base_url+'/inpatient/all')
                    .then(function (response) {
